-- Please give Credits if you took anything 
-- credits mrpopcat14 - omega0megaq - lolcat and kardian scripting team
 
local DrRayLibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/AZYsGithub/DrRay-UI-Library/main/DrRay.lua"))()
local window = DrRayLibrary:Load("Lightheaded Omega Hub!", "Default")
 
local tab = DrRayLibrary.newTab("Main", "4483345998")
 
tab.newButton("Blackking Rework", "Cool script!", function()   
loadstring(game:HttpGet("https://rawscripts.net/raw/FLOOR-2-DOORS-Blackking-Rework-Is-Back-Floor-2-Only-No-Key-17914"))()
end)
 
tab.newButton("remove seek & queen grumble", "bypass seek and queen grumble!", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/ICraftPe/ICraftPe/main/DF2"))()
end)
 
tab.newButton("FFJ V2", "goated doors script new update", function()
...
-- Q TO SPAWN
-- credits mrpopcat14 on youtuber
-- lolcat and kardian scripting team
...
tab.newButton("Mspaint V2", "Most fun script EVER.", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/notpoiu/mspaint/main/main.lua"))()
end)
 
tab.newButton("Buffed shears", "Cut everything you see!", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/MrNeRD0/Doors-Hack/main/shears_done.lua"))()
end)
 
tab.newButton("Flamethrower", "Burn everything you see!", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/JohnyGamingLUA/FlamethrowerDOORS/main/obfuscated.lua"))()
end)
 
tab.newButton("Eat everything", "Become caseoh's size!", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/JohnyGamingLUA/EatEverythingDOORS/main/obfuscated.lua"))()
end)
 
tab.newButton("Rocket launcher", "Blow up the place!", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/JohnyGamingLUA/RocketLauncherUniversal/main/obfuscated.lua"))()
end)
 
tab.newButton("Kiwi's backdoor script", "Beat backdoor easily!", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/iimateiYT/Scripts/main/Backdoors.lua"))()
end)
 
tab.newButton("Seek gun", "Seekify everything!", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/notpoiu/Scripts/main/seekgun.lua"))()
end)
 
tab.newButton("Mobile keyboard", "You can feel like your playing on a keyboard!", function()
loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-Mobile-keyboard-6975"))()
end)
 
tab.newButton("Doors floor 2 script", "Credits to the WT Team!", function()
loadstring(game:HttpGet("https://roblox-hub.onrender.com/raw/launcher/wt_doors_yt", true))()
end)
 
tab.newButton("Entity morph", "Become a monster!", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/ChronoAccelerator/Public-Scripts/main/Morphing/MorphScript.lua"))();
end)
 
tab.newButton("Giggle spawner", "Spawn giggle in any floor!", function()
getgenv().damage = 7 -- Default: 7
